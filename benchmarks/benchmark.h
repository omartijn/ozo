...
template <typename T>
std::ostream& operator <<(std::ostream& stream, const __OZO_STD_OPTIONAL<T>& value) {
    if (value) {
        return stream << *value;
    } else {
        return stream << "null";
...
struct stats {
    __OZO_STD_OPTIONAL<std::chrono::steady_clock::duration> mean_request_time;
    __OZO_STD_OPTIONAL<std::chrono::steady_clock::duration> median_request_time;
    __OZO_STD_OPTIONAL<std::chrono::steady_clock::duration> q90_request_time;
    __OZO_STD_OPTIONAL<std::chrono::steady_clock::duration> min_request_time;
    __OZO_STD_OPTIONAL<std::chrono::steady_clock::duration> max_request_time;
    double mean_request_speed;
    __OZO_STD_OPTIONAL<double> median_request_speed;
    __OZO_STD_OPTIONAL<double> min_request_speed;
    __OZO_STD_OPTIONAL<double> max_request_speed;
    double mean_read_rows_speed;
    __OZO_STD_OPTIONAL<double> median_read_rows_speed;
    __OZO_STD_OPTIONAL<double> min_read_rows_speed;
    __OZO_STD_OPTIONAL<double> max_read_rows_speed;
};
